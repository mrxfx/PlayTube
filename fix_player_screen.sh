...
in_block { next }
{ print }
' app/src/main/java/com/rahul/vibetube/ui/screens/player/PlayerScreen.kt > temp.kt && mv temp.kt app/src/main/java/com/rahul/vibetube/ui/screens/player/PlayerScreen.kt
